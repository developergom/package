    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            <header class="main-header">
                <a href="#" class="logo">
                    <span class="logo-mini"><strong>Conf</strong></span>
                    <span class="logo-lg">App Configuration</span>
                </a>
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="key" name="key" id="key" class="form-control" value="<?php echo set_value('key'); ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="multipleinput" class="control-label col-sm-2">Multiple Input</label>
                                        <div class="col-sm-10">
                                            <select name="multipleinput" id="multipleinput" class="form-control" required>
                                                <option value=""></option>
                                ...
                                <div class="box-footer clearfix">
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <?php echo anchor(base_url().'appconfiguration', '<span class="fa fa-undo"></span> Back', 'class="btn btn-default"') ?>
                                        </div>
                                    </div>
                                </div>
                                <?php echo form_close() ?>
