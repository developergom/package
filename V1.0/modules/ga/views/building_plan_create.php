<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            <?php echo form_open('ga/building_plan/create/', 'class="form-horizontal"') ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-7 col-lg-7">
                        <?php echo form_input('building_plan_unit', set_value('building_plan_unit'), 'class="form-control" placeholder="Building Plan Unit" data-bv-notempty="true"') ?>
                    </div>
