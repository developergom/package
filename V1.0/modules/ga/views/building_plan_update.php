<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            <?php echo form_open('ga/building_plan/edit/', 'class="form-horizontal"', ['building_plan_id' => $building_plan->building_plan_id]) ?>
                ...
                <div class="row">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-7 col-lg-7">
                            <?php echo form_dropdown('building_plan_unit', $building_plan_unit, $building_plan->building_plan_unit, 'class="form-control select2"') ?>
                        </div>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-7 col-lg-7">
                            <?php echo form_dropdown('building_plan_level', $building_plan_level, $building_plan->building_plan_level, 'class="form-control select2"') ?>
                        </div>
                        <?php //echo form_label(form_error('mnme'), NULL, array('class' => 'col-xs-4 col-sm-4 col-md-3 col-lg-3')) ?>
                    </div>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-7 col-lg-7">
                            <?php echo form_textarea('building_plan_description', $building_plan->building_plan_description, 'class="form-control" placeholder="Building Plan Description" data-bv-notempty="true"') ?>
                        </div>
                        <?php //echo form_label(form_error('mnme'), NULL, array('class' => 'col-xs-4 col-sm-4 col-md-3 col-lg-3')) ?>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <?php echo form_label(form_checkbox('building_plan_status', 'active', (bool) ($building_plan->building_plan_status == 'active')) . nbs() . 'Is Active ?') ?>
                        </div>
                    </div>
                </div>
            </div>
