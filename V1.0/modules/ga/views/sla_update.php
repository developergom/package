<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            <?php echo form_open('ga/sla/edit/', 'class="form-horizontal"', ['sla_id' => $sla_id]) ?>
            <div class="box-header">
                <?php echo heading('<i class="fa fa-pencil"></i> Edit A SLA', 3, 'class="box-title"') ?>
            </div>
            <div class="box-body">
                <div class="row">
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-7 col-lg-7">
                        <?php echo form_input('sla_day', $sla->sla_day, 'class="form-control" placeholder="SLA Day" data-bv-notempty="true"') ?>
                    </div>
