<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            <?php echo form_open('ga/extention/edit/', 'class="form-horizontal"', ['extention_id' => $extention_id]) ?>
            <div class="box-header">
                <?php echo heading('<i class="fa fa-pencil"></i> Edit An Extention', 3, 'class="box-title"') ?>
            </div>
            <div class="box-body">
                <div class="row">
                ...
                <div class="form-group has-feedback">
                    <?php echo form_label('Extention Number', NULL, ['class' => 'col-xs-4 col-sm-4 col-md-2 col-lg-2 control-label']) ?>
                    <div class="col-xs-4 col-sm-4 col-md-7 col-lg-7">
                        <?php echo form_input('extention_number', $extention->extention_number, 'class="form-control" placeholder="Extention Extention Number" data-bv-notempty="true"') ?>
                    </div>
