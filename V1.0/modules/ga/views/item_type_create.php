<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            <?php echo form_open('ga/item_type/insert/', 'class="form-horizontal"') ?>
            <div class="box-header">
                <?php echo heading('<i class="fa fa-pencil"></i> Create New Item Type', 3, 'class="box-title"') ?>
            </div>
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-7 col-lg-7">
                            <?php echo form_input('item_type_name', set_value('item_type_name'), 'class="form-control" placeholder="Item Type Name" data-bv-notempty="true"') ?>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <?php echo form_label(form_checkbox('item_type_status', 'active') . ' Is Active ?') ?>
                        </div>
                    </div>
                </div>
            </div>
