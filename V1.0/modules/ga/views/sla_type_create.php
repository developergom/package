<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            <?php echo form_open('ga/sla_type/insert/', 'class="form-horizontal"') ?>
            <div class="box-header">
                <?php echo heading('<i class="fa fa-pencil"></i> Create New SLA Type', 3, 'class="box-title"') ?>
            </div>
            <div class="box-body">
                <div class="row">
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-7 col-lg-7">
                        <?php echo form_input('sla_type_name', set_value('sla_type_name'), 'class="form-control" placeholder="SLA Type Name" data-bv-notempty="true"') ?>
                    </div>
