<div class="row">
	<div class="col-md-12">
		<div class="box box-info">
			<?php echo form_open('sso/menu/insert/', 'class="form-horizontal"') ?>
			<div class="box-header">
				<?php echo heading('<i class="fa fa-pencil"></i> Create New Menu', 3, 'class="box-title"') ?>
			</div>
			<div class="box-body">
				<div class="row">
				...
				<div class="form-group has-feedback">
					...
					<div class="col-xs-4 col-sm-4 col-md-7 col-lg-7">
                        <?php echo form_dropdown('apps_id', $apps_data , set_value('apps_id'), 'class="form-control select2" id="apps_id"') ?>
                    </div>
				</div>
				<?php
