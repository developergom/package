	...
	<div class="col-md-12">
		<div class="box box-info">
			...
			<div class="box-header">
				<?php echo heading('<i class="fa fa-pencil"></i> Edit Menu', 3, 'class="box-title"') ?>
			</div>
			<div class="box-body">
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
                        ...
                        <?php } ?>
                        <input type="hidden" name="menu_id" value="<?php echo $record->menu_id; ?>">
                    </div>
				</div>
				<div class="form-group has-feedback">
					<?php echo form_label('Apps Name', NULL, ['class' => 'col-xs-4 col-sm-4 col-md-2 col-lg-2 control-label']) ?>
					<div class="col-xs-4 col-sm-4 col-md-7 col-lg-7">
                        <?php echo form_dropdown('apps_id', $apps_data , $selected_apps->app_id, 'class="form-control select2" id="apps_id"') ?>
                    </div>
				</div>
				<?php
