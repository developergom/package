...
<section id="slider">
    <div id="home-carousel" class="carousel slide" data-ride="carousel">			
        <div class="carousel-inner">
            <div class="item active" style="background-image: url(../asset/img/gaportal/slider/01.jpg)">
            ...
            <div class="item" style="background-image: url(../asset/img/gaportal/slider/02.jpg)">
                <div class="carousel-caption container">
                    <div class="row">
                        <div class="col-sm-7">
                            <h1>You are entire </h1>
            ...
            <div class="item" style="background-image: url(../asset/img/gaportal/slider/03.jpg)">
                <div class="carousel-caption container">
                    <div class="row">
                        <div class="col-sm-7">
                            <h1>You are entire </h1>
            ...
            <div class="item" style="background-image: url(../asset/img/gaportal/slider/04.jpg)">
                <div class="carousel-caption container">
                    <div class="row">
                        <div class="col-sm-7">
                            <h1>You are entire </h1>
                ...
                <div class="portfolio-items">
                    ...
                    <div class="col-md-4 col-sm-6 work-grid wordpress graphic">
                        <div class="portfolio-content">
                            <img class="img-responsive" src="../asset/img/gaportal/works/portfolio-1.jpg" alt="">
                            <div class="portfolio-overlay">
                                <a href="../asset/img/gaportal/works/portfolio-1.jpg"><i class="fa fa-camera-retro"></i></a>
                    ...
                    <div class="col-md-4 col-sm-6 work-grid html php bootstrap">
                        <div class="portfolio-content">
                            <img class="img-responsive" src="../asset/img/gaportal/works/portfolio-2.jpg" alt="">
                            <div class="portfolio-overlay">
                                <a href="../asset/img/gaportal/works/portfolio-2.jpg"><i class="fa fa-camera-retro"></i></a>
                                <h5>Web Development</h5>
                                <p>Design, Develop</p>
                            </div>
                        </div>	
                    ...
                    <div class="col-md-4 col-sm-6 work-grid wordpress graphic">
                        <div class="portfolio-content">
                            <img class="img-responsive" src="../asset/img/gaportal/works/portfolio-3.jpg" alt="">
                            <div class="portfolio-overlay">
                                <a href="../asset/img/gaportal/works/portfolio-3.jpg"><i class="fa fa-camera-retro"></i></a>
                                <h5>Web Development</h5>
                                <p>Design, Develop</p>
                            </div>
                        </div>	
                    ...
                    <div class="col-md-4 col-sm-6 work-grid html php bootstrap">
                        <div class="portfolio-content">
                            <img class="img-responsive" src="../asset/img/gaportal/works/portfolio-4.jpg" alt="">
                            <div class="portfolio-overlay">
                                <a href="../asset/img/gaportal/works/portfolio-4.jpg"><i class="fa fa-camera-retro"></i></a>
                                <h5>Web Development</h5>
                                <p>Design, Develop</p>
                            </div>
                        </div>	
                    ...
                    <div class="col-md-4 col-sm-6 work-grid wordpress graphic php">
                        <div class="portfolio-content">
                            <img class="img-responsive" src="../asset/img/gaportal/works/portfolio-5.jpg" alt="">
                            <div class="portfolio-overlay">
                                <a href="../asset/img/gaportal/works/portfolio-5.jpg"><i class="fa fa-camera-retro"></i></a>
                                <h5>Web Development</h5>
                                <p>Design, Develop</p>
                            </div>
                        </div>	
                    ...
                    <div class="col-md-4 col-sm-6 work-grid html bootstrap graphic">
                        <div class="portfolio-content">
                            <img class="img-responsive" src="../asset/img/gaportal/works/portfolio-6.jpg" alt="">
                            <div class="portfolio-overlay">
                                <a href="../asset/img/gaportal/works/portfolio-6.jpg"><i class="fa fa-camera-retro"></i></a>
                                <h5>Web Development</h5>
                                <p>Design, Develop</p>
                            </div>
                        </div>	
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="team-member">
                    <div class="member-image">
                        <img class="img-responsive" src="../asset/img/gaportal/members/team1.jpg" alt="">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="team-member">
                    <div class="member-image">
                        <img class="img-responsive" src="../asset/img/gaportal/members/team2.jpg" alt="">
                        <div class="member-social">
                            <a href=""><i class="fa fa-facebook"></i></a>
                            <a href=""><i class="fa fa-twitter"></i></a>
                            <a href=""><i class="fa fa-google-plus"></i></a>
                ...
                <div id="office-carousel" class="carousel slide" data-ride="carousel">			
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="../asset/img/gaportal/office/04.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="../asset/img/gaportal/office/02.jpg" alt="">			
                        </div>
                        <div class="item">
                            <img src="../asset/img/gaportal/office/03.jpg" alt="">			
                        </div>
