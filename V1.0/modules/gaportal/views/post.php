        ...
        <div class="row">
            <div class="col-md-9">
                <div class="single-blog">
                    <article>
                        <div class="post-thumb"><img class="img-responsive" src="../asset/img/gaportal/blog/01.jpg" alt=""></div>
                            ...
                            <div id="post-carousel" class="carousel slide" data-ride="carousel">			
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <img src="../asset/img/gaportal/blog/01.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="../asset/img/gaportal/blog/02.jpg" alt="">			
                                    </div>
                                    <div class="item">
                                        <img src="../asset/img/gaportal/blog/03.jpg" alt="">			
                                    </div>
            ...
            <div class="col-md-3">
                ...
                <div class="sidebar-widget">
                    ...
                    <ul class="content-flickr">
                        <li>
                            <a href="#" title="">
                                <img class="img-responsive" src="../asset/img/gaportal/img1.png" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img class="img-responsive" src="../asset/img/gaportal/img2.png" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img class="img-responsive" src="../asset/img/gaportal/img3.png" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img class="img-responsive" src="../asset/img/gaportal/img4.png" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img class="img-responsive" src="../asset/img/gaportal/img5.png" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img class="img-responsive" src="../asset/img/gaportal/img6.png" alt="">
                            </a>
                        </li>
                    </ul>
                </div>
