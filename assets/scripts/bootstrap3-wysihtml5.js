    ...
    var tpl = {
        ...
        "image": function (locale, options) {
            ...
            return "<li>" +
                    ...
                    "<form name='photo' id='imageUploadForm' enctype='multipart/form-data' action='" + base_url + "gaportal/media/upload/' method='post'>" +
                    ...
                    "<hr>" +
                    "<div class='imageLink'>" +
                    "<h4>Or insert the link of a online image.</h4>" +
        ...
        initInsertImage: function (toolbar) {
            ...
            toolbar.find('a[data-wysihtml5-command=insertImage]').click(function () {
                ...
                if (!activeButton) {
                    ...
                    insertImageModal.find("input[name=imageUploaded]").remove();
                    insertImageModal.find("h5").remove();
                    insertImageModal.find("div.imageLink").slideDown(0);
